...
class Arduino {
  ...
  var firmata: com.adthan.firmakka.sjf.Firmata = null
  ...
  class FirmataWriter extends com.adthan.firmakka.sjf.Firmata.Writer {
    def write(`val`: Int) {
      serial.write(`val`)
    }
  }
...
//    }
  ...
  def this(iname: String, irate: Int) {
    ...
    this.firmata = new com.adthan.firmakka.sjf.Firmata(new FirmataWriter)
